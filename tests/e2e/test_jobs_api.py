...
from betedge_data.manager.external_models import ExternalHistoricalStockRequest
from betedge_data.manager.service import DataProcessingService
from betedge_data.manager.job_tracker import JobTracker, JobStatus
...
def run_tests():
    ...
    try:
        ...
        run_test_method(integration_suite, "Job Creation Integration", integration_suite.test_jobs_endpoint_after_job_creation)
        run_test_method(integration_suite, "Multiple Jobs Filtering", integration_suite.test_jobs_filtering_after_multiple_jobs)
