...
class MinIOPublisher:
    ...
    async def publish_parquet_data(self, parquet_buffer: io.BytesIO, config: MinIOPublishConfig) -> int:
        """
    ...
    def list_existing_files(
        self, root: str, dates: List[str], interval: int, exp: str, schema: str = "quote", filter_type: str = "filtered"
    ) -> Set[str]:
        """
        ...
        try:
            for date in dates:
                ...
                config = MinIOPublishConfig(
                    schema=schema, root=root, date=date, interval=interval, exp=exp, filter_type=filter_type
                )
    ...
    def list_files_for_symbol(
        self, root: str, schema: str = None, start_date: str = None, end_date: str = None, limit: int = None
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_bucket_stats(self) -> Dict[str, Any]:
        ...
        """
        try:
            objects = self.client.list_objects(bucket_name=self.bucket, prefix="historical-options/", recursive=True)
