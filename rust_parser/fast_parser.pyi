...
def filter_contracts_to_ipc_bytes(
    ...
    Example:
        ...
        >>> ipc_bytes = fast_parser.filter_contracts_to_ipc_bytes(option_data, stock_data, 20231110, 30, 0.1)
...
def filter_contracts_to_parquet_bytes(
    ...
    Example:
        ...
        >>> option_data = '{"header": {...}, "response": [...]}'
        >>> stock_data = '{"header": {...}, "response": [...]}'
        >>> parquet_bytes = fast_parser.filter_contracts_to_parquet_bytes(option_data, stock_data, 20231110, 30, 0.1)
